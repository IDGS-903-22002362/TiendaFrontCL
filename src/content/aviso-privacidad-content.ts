...
export const RESPONSABLE = "Fuerza Deportiva del Club León";
export const RFC_RESPONSABLE = "FDC101202CG6";
export const MARCA_COMERCIAL = "La Guarida del León";
export const DOMICILIO_LEGAL = "Blvd. Adolfo López Mateos Oriente 1810, Colonia La Martinica, C.P. 37500, León, Guanajuato, México";
export const CORREO_PRIVACIDAD = "laguaridadelleon1944@gmail.com";
export const SITIO_WEB = "https://tiendalaguarida.com";

export const AVISO_INTRO = "El presente aviso se elaboró considerando la Ley Federal de Protección de Datos Personales en Posesión de los Particulares, cuya última reforma oficial fue publicada el 14 de noviembre de 2025. La autoridad federal competente en materia de protección de datos personales en posesión de particulares es actualmente la Secretaría Anticorrupción y Buen Gobierno.";

export const AVISO_SECTIONS: AvisoSection[] = [
  {
    "id": "1",
    ...
    "blocks": [
      {
        ...
        "parts": [
          {
            "type": "strong",
            "value": "Fuerza Deportiva del Club León",
          },
          {
            "type": "text",
            "value": ", con RFC FDC101202CG6, comercialmente identificada como \"La Guarida del León\", con domicilio en ",
          },
          {
            "type": "domicilio",
          },
          {
            "type": "text",
            "value": ", es responsable del tratamiento, uso, almacenamiento, protección y, en su caso, transferencia de los datos personales recabados a través del sitio ",
          },
          {
            "type": "link",
            "href": "https://tiendalaguarida.com",
            "label": "https://tiendalaguarida.com",
          },
          {
            "type": "text",
            "value": ".",
      ...
      },
      {
        ...
        "parts": [
          {
            "type": "text",
            "value": "Para cualquier asunto relacionado con privacidad y protección de datos personales, las personas titulares podrán comunicarse mediante:",
          },
        ],
      },
      {
        "type": "list",
        "items": [
          "Correo electrónico: laguaridadelleon1944@gmail.com",
          "Sitio web: https://tiendalaguarida.com",
          "Domicilio: Blvd. Adolfo López Mateos Oriente 1810, Colonia La Martinica, C.P. 37500, León, Guanajuato, México",
        ],
      },
      {
        "type": "paragraph",
        "parts": [
          {
            "type": "text",
            "value": "Para efectos del presente aviso, Fuerza Deportiva del Club León será denominada indistintamente como \"La Guarida del León\", \"la tienda\" o \"el responsable\".",
          },
        ],
      },
    ],
    ...
    "blocks": [
      {
        ...
        "parts": [
          {
            "type": "text",
            "value": "Este Aviso de Privacidad aplica al tratamiento de datos personales recabados mediante:",
          },
        ],
      },
      {
        "type": "list",
        "items": [
          "El sitio web https://tiendalaguarida.com.",
          ...
          "Cualquier otro servicio digital operado directamente por La Guarida del León.",
        ],
      },
    ],
  },
    ...
    "blocks": [
      {
        ...
        "parts": [
          {
            "type": "text",
            "value": "Dependiendo de la forma en que la persona usuaria interactúe con la tienda, podrán tratarse las siguientes categorías de información.",
          },
        ],
      },
      {
        ...
        "blocks": [
          {
            ...
            "parts": [
              {
                "type": "text",
                "value": "Para gestionar pagos podrán tratarse:",
              },
            ],
          },
          {
        ...
        "blocks": [
          {
            ...
            "parts": [
              {
                "type": "text",
                "value": "Cuando la tienda habilite una función para visualizar productos mediante generación o edición de imágenes, podrán tratarse:",
              },
            ],
          },
          {
    ...
    "blocks": [
      {
        ...
        "parts": [
          {
            "type": "text",
            "value": "La Guarida del León no requiere datos personales sensibles para realizar una compra ordinaria.",
          },
        ],
      },
      {
        ...
        "parts": [
          {
            "type": "text",
            "value": "Se solicita a las personas usuarias no proporcionar mediante formularios, mensajes, reseñas o archivos información relacionada con:",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        "parts": [
          {
            "type": "text",
            "value": "Cuando excepcionalmente resulte indispensable tratar información sensible, se solicitará el consentimiento expreso correspondiente y se implementarán medidas de seguridad reforzadas.",
          },
        ],
      },
    ],
    ...
    "blocks": [
      {
        ...
        "parts": [
          {
            "type": "text",
            "value": "Los datos podrán obtenerse:",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        "parts": [
          {
            "type": "text",
            "value": "Cuando una persona proporcione datos de un tercero, declara que cuenta con autorización para hacerlo y que ha informado a dicho tercero sobre el tratamiento de sus datos.",
          },
        ],
      },
    ],
    ...
    "blocks": [
      {
        ...
        "parts": [
          {
            "type": "text",
            "value": "La Guarida del León tratará los datos personales para las siguientes finalidades indispensables:",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        "parts": [
          {
            "type": "text",
            "value": "La negativa a proporcionar los datos necesarios puede impedir que la tienda procese una compra, entregue un producto, emita una factura o atienda una solicitud.",
          },
        ],
      },
    ],
    ...
    "blocks": [
      {
        ...
        "parts": [
          {
            "type": "text",
            "value": "Con autorización de la persona titular, los datos podrán utilizarse para:",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        "parts": [
          {
            "type": "text",
            "value": "La persona podrá oponerse a ellas mediante:",
          },
        ],
      },
      {
        ...
        "items": [
          ...
          "Una solicitud enviada a laguaridadelleon1944@gmail.com.",
        ],
      },
      {
        "type": "paragraph",
        "parts": [
          {
            "type": "text",
            "value": "La negativa a recibir publicidad no afectará las compras ni los servicios contratados.",
          },
        ],
      },
    ],
    ...
    "blocks": [
      ...
      },
      {
        ...
        "parts": [
          {
            "type": "text",
            "value": "La Guarida del León no deberá almacenar el número completo de la tarjeta ni su código de seguridad. La persona usuaria también deberá consultar el aviso de privacidad del proveedor de pagos utilizado.",
          },
        ],
      },
    ],
    ...
    "blocks": [
      {
        ...
        "parts": [
          {
            "type": "text",
            "value": "La Guarida del León podrá transferir o comunicar datos personales a:",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        "parts": [
          {
            "type": "text",
            "value": "No se venderán ni rentarán bases de datos personales a terceros. Las transferencias que requieran consentimiento se realizarán únicamente después de obtenerlo.",
          },
        ],
      },
    ],
    ...
    "blocks": [
      ...
      },
      {
        ...
        "parts": [
          {
            "type": "text",
            "value": "Las tecnologías no necesarias se utilizarán conforme a la selección realizada por la persona usuaria en el administrador de cookies. Las preferencias podrán modificarse en cualquier momento mediante la opción \"Configurar cookies\" o consultando nuestra ",
          },
          {
            "type": "link",
    ...
    "blocks": [
      {
        ...
        "parts": [
          {
            "type": "text",
            "value": "La persona titular podrá limitar el uso o divulgación de sus datos personales mediante las configuraciones de su cuenta, el administrador de cookies, el enlace para cancelar suscripción o una solicitud enviada a ",
          },
          {
            "type": "correo",
          },
          {
            "type": "text",
            "value": ". La solicitud deberá incluir nombre completo, correo asociado a la cuenta, descripción de los usos que desea limitar y medio para recibir respuesta.",
          },
        ],
      },
    ],
    ...
    "blocks": [
      {
        ...
        "parts": [
          {
            "type": "text",
            "value": "La persona titular podrá revocar su consentimiento para los tratamientos que dependan de este, sin efectos retroactivos, enviando una solicitud a ",
          },
          {
            "type": "correo",
          },
          {
            "type": "text",
            "value": " con asunto \"Revocación de consentimiento\", indicando nombre completo, medio de contacto, tratamiento respecto del cual desea revocar el consentimiento e información que permita localizar sus datos.",
          },
        ],
      },
    ],
    ...
    "blocks": [
      {
        ...
        "parts": [
          {
            "type": "text",
            "value": "La persona titular puede ejercer los derechos de Acceso, Rectificación, Cancelación y Oposición (ARCO) conforme a la LFPDPPP.",
          },
        ],
      },
      {
        ...
        "parts": [
          {
            "type": "text",
            "value": "La solicitud deberá enviarse a ",
          },
          {
            "type": "correo",
          },
          {
            "type": "text",
            "value": " con asunto \"Solicitud de derechos ARCO\" e incluir nombre completo, domicilio o correo para notificaciones, documento que acredite identidad, descripción de los datos involucrados, derecho que desea ejercer y petición concreta.",
          },
        ],
      },
      {
        ...
        "parts": [
          {
            "type": "text",
            "value": "La Guarida del León comunicará su determinación dentro de un plazo máximo de 20 días, contado desde la recepción de la solicitud. Cuando la solicitud sea procedente, se hará efectiva dentro de los 15 días siguientes a la comunicación de la respuesta. Los plazos podrán ampliarse una sola vez por un periodo igual cuando las circunstancias lo justifiquen, conforme al artículo 31 de la LFPDPPP vigente.",
          },
        ],
      },
    ],
    ...
    "blocks": [
      {
        ...
        "parts": [
          {
            "type": "text",
            "value": "El sitio puede incluir enlaces o integraciones de terceros, como procesadores de pago, empresas de mensajería, redes sociales, servicios de autenticación, plataformas de seguimiento o herramientas de soporte. Cada tercero es responsable de sus propias prácticas de privacidad.",
          },
        ],
      },
    ],
    ...
    "blocks": [
      {
        ...
        "parts": [
          {
            "type": "text",
            "value": "La Guarida del León podrá modificar este Aviso de Privacidad debido a cambios legales, nuevas funciones, nuevos métodos de pago, cambios en proveedores, nuevas finalidades, modificaciones de seguridad o cambios corporativos u operativos. La versión vigente estará disponible en ",
          },
          {
            "type": "link",
            "href": "/aviso-de-privacidad",
            "label": "https://tiendalaguarida.com/aviso-de-privacidad",
          },
          {
            "type": "text",
            "value": ". Cuando una modificación sea sustancial, podrá comunicarse mediante aviso visible en el sitio, correo electrónico, mensaje dentro de la cuenta o notificación durante el proceso de compra.",
          },
        ],
      },
    ],
    ...
    "blocks": [
      {
        ...
        "parts": [
          {
            "type": "text",
            "value": "Cuando una persona considere que su derecho a la protección de datos personales ha sido vulnerado, podrá acudir ante la Secretaría Anticorrupción y Buen Gobierno, autoridad federal competente en la materia. Antes de iniciar un procedimiento, puede contactar a La Guarida del León mediante ",
          },
          {
            "type": "correo",
          },
