  ...
  const badgeTone =
    badge?.label === "Agotado"
      ...
      : badge?.label === "Oferta"
        ...
        : "border-black bg-black text-white";
  const ariaLabel = `Ver ${product.name}`;
  const isApparel = isPersonalizableProduct(product);
    ...
    <article className="group flex h-full flex-col">
      <div className="relative">
        ...
        >
          <HoverImagePreview
            ...
            alt={product.name}
            sizes="(max-width: 640px) 72vw, (max-width: 1024px) 42vw, (max-width: 1400px) 30vw, 24vw"
      ...
      <div className="mt-3 flex flex-1 flex-col md:mt-4">
        <div className="flex items-baseline gap-2.5">
          <p className="text-[1.45rem] font-semibold leading-none tracking-[-0.03em] text-foreground md:text-[1.68rem]">
