...
const alertVariants = cva(
  "relative w-full rounded-2xl border border-border/80 bg-card p-4 text-foreground shadow-none [&>svg~*]:pl-8 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4",
  {
    variants: {
      variant: {
