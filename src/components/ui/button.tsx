...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl border border-transparent text-sm font-semibold tracking-tight ring-offset-background transition-all duration-200 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-[var(--shadow-glow)] hover:bg-[var(--primary-hover)] hover:shadow-[0_24px_54px_-36px_rgb(0_122_83_/_0.45)] active:translate-y-px",
        destructive:
        ...
        outline:
          "border-border bg-card/95 text-foreground shadow-[var(--shadow-card)] hover:border-primary/45 hover:bg-accent hover:text-foreground",
        secondary:
        ...
        ghost:
          "border-transparent bg-transparent text-text-secondary hover:bg-accent hover:text-foreground",
