...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t border-border bg-muted/65 font-medium [&>tr]:last:border-b-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-4 text-left align-middle text-[11px] font-semibold uppercase tracking-[0.18em] text-text-muted [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
