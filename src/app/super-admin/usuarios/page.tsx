    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <h1 className="text-3xl font-bold">Gestión Completa de Usuarios</h1>
                <p className="text-sm text-gray-600">{usuarios.length} usuarios totales</p>
            </div>
                                    ...
                                    <div className="flex gap-2 items-center">
                                        ...
                                        <Button
                                            ...
                                            onClick={() => {
                                                ...
                                                toast({
                                                    title: "Copiado",
                                                    description: "Contraseña copiad al portapapeles",
                                                });
                                            }}
                                        >
                                            Copiar
